...
6. [docs/PLAYER_3_ARCHITECTURE.md](../playback/PLAYER_3_ARCHITECTURE.md) — architecture supplement.
7. [docs/PLAYER_3_RUNTIME_VALIDATION.md](../playback/PLAYER_3_RUNTIME_VALIDATION.md) — command-level runtime evidence.
8. [docs/PLAYER_3_REAL_PROVIDER_ACCEPTANCE.md](../playback/PLAYER_3_REAL_PROVIDER_ACCEPTANCE.md) — controlled credential-safe acceptance procedure.
