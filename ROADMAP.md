...
| Xtream Codes | Credential-safe request and translation foundation | Encoded `player_api.php` and playback URL construction; live API client remains next | Canonical `Channel` translation for live-stream DTOs | Focused request-builder and live DTO translation tests | None | **Partially implemented** |
