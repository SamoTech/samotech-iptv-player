...
> **Completed milestone:** Core recovery, MAG provider integration, an initial domain-oriented M3U parser, and validated VOD movie/series metadata.
...
| **2** | Complete domain entities and value objects; M3U parser; parser and domain unit tests | **In progress** — extended-M3U parser plus VOD movie/series validation and focused tests delivered; remaining domain coverage continues |
