...
| Xtream Codes | Credential-safe request foundation | Encoded `player_api.php` and playback URL construction; no API client or DTO translation yet | Canonical domain mapping planned | Focused request-builder tests | None | **Partially implemented** |
