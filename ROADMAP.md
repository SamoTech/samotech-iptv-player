...
> **Completed milestone:** Core recovery, MAG provider integration, an initial domain-oriented M3U parser, validated VOD movie/series metadata, and hardened user-library records.
...
| **2** | Complete domain entities and value objects; M3U parser; parser and domain unit tests | **In progress** — extended-M3U parser, VOD movie/series validation, and Favorite/History invariants with focused tests delivered; remaining domain coverage continues |
