...
| Xtream Codes | Credential-safe request, API, and translation foundation | Encoded `player_api.php`, authentication response validation, live-stream DTO retrieval, and playback URL construction; adapter composition remains next | Canonical `Channel` translation for live-stream DTOs | Focused request-builder, API-client, and live DTO translation tests | None | **Partially implemented** |
