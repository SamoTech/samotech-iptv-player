...
class MagDomainTranslator:
    ...
    @staticmethod
    def channel(raw: Mapping[str, Any], provider_id: ProviderId) -> Channel:
    ...
    @staticmethod
    def channels(raw_records: Sequence[Mapping[str, Any]], provider_id: ProviderId) -> list[Channel]:
    ...
    @staticmethod
    def epg_entries(
        raw_records: Sequence[Mapping[str, Any]], channel_id: ChannelId
    ) -> list[EPGEntry]:
    ...
    @staticmethod
    def epg_entry(raw: Mapping[str, Any], channel_id: ChannelId) -> EPGEntry:
    ...
    @staticmethod
    def _required_timestamp(raw: Mapping[str, Any], *keys: str) -> int:
        for key in keys:
            value = raw.get(key)
