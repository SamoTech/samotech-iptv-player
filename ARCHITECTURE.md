...
History storage now adds provider-scoped identity, nullable lifecycle timestamps, runtime progress, watched percentage, completion, and a backward-compatible SQLite migration. Resume is restored only for matching incomplete Movie/Episode history and only after successful play. Full design and runtime evidence are recorded in [`docs/PLAYER_2_ARCHITECTURE.md`](docs/playback/PLAYER_2_ARCHITECTURE.md) and [`docs/PLAYER_2_RUNTIME_VALIDATION.md`](docs/playback/PLAYER_2_RUNTIME_VALIDATION.md).
...
The implementation and evidence are recorded in [PLAYER_3_FINAL_AUDIT.md](docs/historical/PLAYER_3_FINAL_AUDIT.md), [docs/PLAYER_3_REAL_PROVIDER_ACCEPTANCE.md](docs/playback/PLAYER_3_REAL_PROVIDER_ACCEPTANCE.md), the focused provider/application/presentation tests, and [docs/PLAYER_3_RUNTIME_VALIDATION.md](docs/playback/PLAYER_3_RUNTIME_VALIDATION.md). Public reference-study attribution remains in [README.md](docs/historical/README.md) and does not change the source-ownership boundary.
